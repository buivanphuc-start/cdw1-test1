...
class FlightController extends Controller
{
    ...
    public function detail(Request $request){
       $airports = new airports();
        ...
        $detail = $flights->where('flights.id',$request->flight_id)->get();
        ...
        $flightDetail = $flights->where('flights.id', $request->flight_id)->get();
        //echo $flightDetail[0]->city_from;
        //echo $request->flight_id;
